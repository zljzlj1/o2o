...
public partial class sw_productguanli : System.Web.UI.Page
{
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        string strSQL = "delete from 产品 where 流水号='" + 流水号 + "'";
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        string 产品名称 = ((TextBox)(GridView1.Rows[e.RowIndex].Cells[1].Controls[0])).Text.Trim();
        string 产品价格 = ((TextBox)(GridView1.Rows[e.RowIndex].Cells[2].Controls[0])).Text.Trim();
        string 产品类别 = ((TextBox)(GridView1.Rows[e.RowIndex].Cells[3].Controls[0])).Text.Trim();

        string strSQL = "Update 产品 set 产品名称='" + 产品名称 + "',产品价格='" + 产品价格 + "',产品类别='" + 产品类别 + "' where 流水号='" + 流水号 + "'";
        DataSet ds = DBA.GetDataSet(strSQL);
