<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xiugaiyonghu.aspx.cs" Inherits="sw_xiugaiyonghu" %>
   ...
   <table style=" border-style: groove; border-width: medium; width:600px; font-family: 楷体_GB2312; font-size: 12px; text-align: left;  margin-left: 20px; margin-top: 10px;" >
           ...
           <tr>
            ...
            <tr>
                <td class="style2">
                    &nbsp;</td>
                 <td><asp:Button ID="Button1" runat="server" Text="修改" onclick="Button1_Click" 
