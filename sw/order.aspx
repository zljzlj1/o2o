<%@ Page Language="C#" AutoEventWireup="true" CodeFile="order.aspx.cs" Inherits="sw_order" %>
...
<div id="mid" style="font-family: 楷体">
   <table align="center">
                  <tr><td style=" width:134px; height:36px"></td>
                  <td align="left" style="width:220px; height:36px"> 订单信息</td></tr>
                  ...
                  <td align="left" style="width:220px; height:33px">
                   ...
                   <td align="left" style="width:220px; height:30px">
                       <asp:Label ID="Label2" runat="server" Text="Label"></asp:Label></td></tr>
                      <tr><td align="right" style="width:134px; height:36px"> 订单数量：</td>
                       <td align="left" style="width:220px; height:36px">
                ...
                <td align="left" style="width:220px; height:38px">
                    <asp:Button ID="Button1" runat="server" Text="提交订单 " onclick="Button1_Click" 
                        Height="27px" Width="83px" BackColor="#BFBEBF" BorderColor="#BFBEBF" 
                         BorderStyle="Outset" BorderWidth="5px"  /></td></tr>
                </table>
