<%@ Page Language="C#" AutoEventWireup="true" CodeFile="guanliyuanaspx.aspx.cs" Inherits="sw_guanliyuanaspx" %>
...
<body>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            onrowupdating="GridView1_RowUpdating" Height="145px">
        ...
        <asp:LinkButton ID="LinkButton4" runat="server" CommandArgument="l" 
            onclick="link" Font-Underline="False">末页</asp:LinkButton>
    </div>
    </form>
</body>
</html>