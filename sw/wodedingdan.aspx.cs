...
public partial class sw_wodedingdan : System.Web.UI.Page
{
    DBAccess1 DBA = new DBAccess1();
    protected void Page_Load(object sender, EventArgs e)
    {
        string vid = Session["name"].ToString();
        string SQLStr = "select * from 订单 where 用户名='" + vid + "'";
        DataSet dg = DBA.GetDataSet(SQLStr);
        DataList1.DataSource = dg.Tables["datatable"].DefaultView;
        DataList1.DataBind();
