<%@ Page Language="C#" AutoEventWireup="true" CodeFile="about-2.aspx.cs" Inherits="sw_about_2" %>
...
<li><a href="qiyezhanshi.aspx"target="fi"><strong>企业展示</strong></a></li>  
 ...
 <div id="right"><iframe width="666px" height="408px" name="fi"  scrolling="no" frameborder="0" src="qiyelinian.aspx"></iframe></div>
 <div id="c"></div>
    </div>
