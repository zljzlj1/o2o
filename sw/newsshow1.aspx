<%@ Page Language="C#" AutoEventWireup="true" CodeFile="newsshow1.aspx.cs" Inherits="sw_newsshow1" %>
...
&nbsp; 发表时间：<asp:Label ID="Label4" runat="server" Text="Label"></asp:Label>
                            &nbsp; 【<asp:HyperLink ID="HyperLink7" runat="server">打印</asp:HyperLink>
                                】&nbsp; 【<asp:HyperLink ID="HyperLink8" runat="server" 
                                    NavigateUrl="~/sw/new1.aspx">返回</asp:HyperLink>
                                】</h3> </td>    
                       ...
                       <td align="center" style="padding-top: 50px">
                               ...
                               <h2><asp:Label ID="Label1" runat="server" Text="Label" BorderColor="White" 
                                       BorderStyle="Groove" BorderWidth="2px" ForeColor="Black"></asp:Label></h2> 
