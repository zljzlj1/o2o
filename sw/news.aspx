<%@ Page Language="C#" AutoEventWireup="true" CodeFile="news.aspx.cs" Inherits="sw_news" %>
...
<li><a href="newsxin1.aspx?id=业内新闻" target="fi"><strong>业内新闻</strong></a></li>
 ...
 <div id="right"><iframe width="666px" height="408px" name="fi"  scrolling="no" frameborder="0" src="newsxin.aspx?id=企业新闻"></iframe></div>
 <div id="c"></div>
    </div>
