...
public partial class sw_chanpinleibie : System.Web.UI.Page
{
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        string strSQL = "delete from 产品类别 where 流水号='" + 流水号 + "'";
    ...
    {
        string 流水号 = GridView1.DataKeys[e.RowIndex].Value.ToString();
        string 产品类别 = ((TextBox)(GridView1.Rows[e.RowIndex].Cells[1].Controls[0])).Text.Trim();
        string strSQL = "Update 产品类别 set 产品类别='" + 产品类别 + "' where 流水号='" + 流水号 + "'";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string strSQL = "insert into 产品类别(产品类别) values('" + mc + "')";
        OleDbDataReader dr = DBA.GetDataReader(strSQL);
        if (mc != "")
        {
        ...
        {
            ClientScript.RegisterStartupScript(ClientScript.GetType(), "alert", " <script> alert('请输入类别！');</script> ");
