<%@ Page Language="C#" AutoEventWireup="true" CodeFile="new1.aspx.cs" Inherits="sw_new1" %>
...
<h2>企业新闻</h2>
<ul id="d2">
<li><a href="newsxin.aspx?id=企业新闻" target="fi"><strong>企业新闻</strong></a></li>
<li><a href="newsxin1.aspx?id=业内新闻" target="fi"><strong>业内新闻</strong></a></li>
</ul>
 </div>
 <div id="right"><iframe width="666px" height="408px" name="fi"  scrolling="no" frameborder="0" src="newsxin1.aspx?id=业内新闻"></iframe></div>
 <div id="c"></div>
    </div>
